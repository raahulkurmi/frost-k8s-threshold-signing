...
import (
	...
	"frost-k8s-threshold-signing/legacy/frost/internal/config"
	"frost-k8s-threshold-signing/legacy/frost/internal/dkg"
	"frost-k8s-threshold-signing/legacy/frost/internal/froststate"
)
